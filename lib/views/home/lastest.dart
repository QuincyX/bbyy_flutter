...
class LastestFeedList extends StatefulWidget {
  LastestFeedList({Key key}) : super(key: key);
  @override
  _LastestFeedListState createState() => _LastestFeedListState();
}

class _LastestFeedListState extends State<LastestFeedList> {
  List list;
